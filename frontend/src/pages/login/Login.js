...
export default function Login() {
  ...
  const refreashToken = async () => {
    try {
      const response = await axios.post("http://localhost:5050/user/refresh", {token: user.refreashToken});
  ...
  return (
    <div>
    {!user ? <div className="bg-slate-100 w-96 rounded-md">
    ...
    </div>: <div className="bg-slate-100 w-96 h-60 rounded-md">
